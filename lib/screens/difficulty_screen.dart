            ...
            child: Column(
              ...
              children: <Widget>[
                FadeTransition(
                  ...
                  child: diffculty_cart("Easy", "150", this.arrayofCheckPoint[0],
                    Difficulty.EASY, poinIconCode, timerIconCode),
                ),
                FadeTransition(
                  opacity: _difficulty_screen_animation.popUp,
                ...
                FadeTransition(
                  opacity: _difficulty_screen_animation.popUp,
                  child: diffculty_cart("Hard", "100", this.arrayofCheckPoint[2],
                    Difficulty.HARD, poinIconCode, timerIconCode),
                ),
                FadeTransition(
                  opacity:_difficulty_screen_animation.popUp,
                  child: diffculty_cart("Enless", "", "", Difficulty.HARD, infiniteIcon,
                    infiniteIcon),
                )
                ,
              ]),
