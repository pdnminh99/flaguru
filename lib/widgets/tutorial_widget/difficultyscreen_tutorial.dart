...
class _DifficultyScreenState extends State<DifficultyScreenTutorial> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    WidgetsBinding.instance
        .addPostFrameCallback((_) => ShowCaseWidget.of(context).startShowCase(mykey));
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                buildHeader(context),
                boolbuildshowcase
                    ? ExpandableDiffCardTutorial(
                        controllers[0],
                        diff: Difficulty.EASY,
                        listkey: mykey,
                      )
                    : ExpandableDiffCard(controllers[0], diff: Difficulty.EASY, onTap: () => {}),
